...
export const AdmissionsCardDrawer: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/35 backdrop-blur-[2px]">
      ...
      >
        <div className="sticky top-0 z-10 border-b border-slate-100 bg-white px-4 py-3 md:px-6 md:py-4">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              <button
                type="button"
                onClick={onClose}
                className="mb-2 inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 transition hover:text-cyan-700 md:hidden"
              >
        ...
        <div className="sticky bottom-0 border-t border-slate-100 bg-white px-4 py-3 pb-safe md:px-6 md:py-4">
          <button
            type="button"
            onClick={onSave}
